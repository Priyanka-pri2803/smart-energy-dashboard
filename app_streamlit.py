...
# --------------------------
# Google Drive file links (Direct download, public access)
# --------------------------
FILES = {
...
if uploaded_file:
    ...
    st.download_button("⬇️ Download Predictions CSV", data=csv_download,
